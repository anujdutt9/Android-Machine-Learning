...
freeze_graph.freeze_graph(input_graph='./saved_model/linear_regression.pbtxt',
                          input_saver='',
                          input_binary=True,
                          input_checkpoint='./saved_model/linear_regression.ckpt',
                          output_node_names='y_out',
                          restore_op_name='save/restore_all',
                          filename_tensor_name='save/Const:0',
                          output_graph='./saved_model/frozen_linear_regression.pb',
                          clear_devices=True,
                          initializer_nodes='',
...
with tf.gfile.Open('./saved_model/frozen_linear_regression.pb', 'rb') as f:
